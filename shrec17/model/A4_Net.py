...
class Model(nn.Module):
    ...
    def __init__(self, smooth_stride=False,p=0.):
        super().__init__()

        group = "A4"
        cap_type = Cap_Type()
        layer_type_list = [[cap_type.get_type("trivial", 1)],
                  [cap_type.get_type("regular", 4)],
                  [cap_type.get_type("regular", 4)],
                  [cap_type.get_type("regular", 8)],
                  [cap_type.get_type("regular", 8)],
                  [cap_type.get_type("regular", 12)],
                  [cap_type.get_type("regular", 12)],
                  [cap_type.get_type("regular", 12)],
        ...
        self.conv3 = PDO_e3DConv(group, layer_type_list[2], layer_type_list[3],stride=1)
        ...
        self.conv6 = PDO_e3DConv(group, layer_type_list[5], layer_type_list[6],stride=1)
